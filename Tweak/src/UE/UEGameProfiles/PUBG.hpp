   ...
   /* std::string GetAppID() const override
    {
       ...
       // return [appID UTF8String];
        return ENCRYPT("com.pubg.imobile");
    }*/
    std::vector<std::string> GetAppID() const override
       {
           return {
               ENCRYPT("com.tencent.ig"),
                       ENCRYPT("com.rekoo.pubgm"),
                               ENCRYPT("com.pubg.imobile"),
                                       ENCRYPT("com.pubg.krmobile"),
                                               ENCRYPT("com.vng.pubgmobile"),
               ENCRYPT("vn.vng.pubgmobile"),
           };
       }
    
        bool Pubgmxx() const override
    {
        return true;
    }
    ...
    {
        return KittyMemory::getMemoryFileInfo(ENCRYPT("ShadowTrackerExtra"));
    }
    ...
    bool Farlightxx() const override
    {
        return false;
    }
    ...
    uintptr_t GetGUObjectArrayPtr() const override
    {
        ...
        const char *bytes = AY_OBFUSCATE("\x80\xB9\x00\x00\x00\x00\x00\x00\x00\x91\x00\x00\x40\xF9\x00\x03\x80\x52");
        const char *mask = AY_OBFUSCATE("xx???????x??xx?xxx");
        const int step = 2;

        uintptr_t insn_address = KittyScanner::findBytesFirst(hdr, AY_OBFUSCATE("__TEXT"), bytes, mask);
        if (insn_address == 0)
            return 0;
    ...
    uintptr_t GetNamesPtr() const override
    {
        ...
        const char *bytes = AY_OBFUSCATE("\xE0\x00\x00\x91\x00\x09\x00\x94\x00\x00\x02");
        const char *mask = AY_OBFUSCATE("x?xx?xxx??x");
        const int step = 8;
    ...
    uintptr_t GetGworld() const override
    {
